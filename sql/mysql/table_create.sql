...
CREATE TABLE CLIENTI (
    ...
    CONSTRAINT PK_CLIENTI PRIMARY KEY (CodiceFiscale)
);
...
CREATE TABLE METODI_PAGAMENTO (
    ...
    CONSTRAINT CK_METODI_PAGAMENTO_TIPO CHECK(Tipo='Conto' OR Tipo='Carta'),
    CONSTRAINT PK_METODI_PAGAMENTO PRIMARY KEY (Codice)
);
...
CREATE TABLE APPARTENENZE_AUTO (
    ...
    CONSTRAINT FK_APPARTENENZE_AUTO_CLIENTE FOREIGN KEY (Cliente) REFERENCES CLIENTI(CodiceFiscale)
);

CREATE TABLE FATTURAZIONI (
    MetodoDiPagamento INT,
    Cliente VARCHAR(16) NOT NULL,

    CONSTRAINT PK_FATTURAZIONI PRIMARY KEY (MetodoDiPagamento),
    CONSTRAINT FK_FATTURAZIONI_CLIENTE FOREIGN KEY (Cliente) REFERENCES CLIENTI(CodiceFiscale)
);
...
CREATE TABLE UTENTI (
    ...
    CONSTRAINT FK_UTENTI FOREIGN KEY (Cliente) REFERENCES CLIENTI(CodiceFiscale)
);